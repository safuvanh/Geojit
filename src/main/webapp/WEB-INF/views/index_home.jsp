...
<!-- Header -->
<header class="w3-display-container w3-content w3-wide" style="max-width:500px; height: 500px; overflow: hidden;" id="home">
  <img style='opacity:.8; width: 100%; height: 100%; object-fit: cover;' class="w3-image" src="${contextPath}/resources/Images/header.jpg" alt="Architecture">
</header>
</header>
<div>
<blockquote><p>
     <h2 align="center" style="font-family: Verdana,sans-serif;color:#1C3B47;">Iam Learning ..</h2>
     <h3 align="center" style="font-family: Verdana,sans-serif;color:#1C3B47;">Azure devops with My Shafeek ikka..</h3> 
</blockquote>
<!-- Page content -->
